...
# ---------------------------------------------------------------------------
# Helper functions (same pattern as test_op13_schema_traits_validation.py)
# ---------------------------------------------------------------------------
...
def _register_instance(instance_body, label="register instance"):
...
def _validate_entity(entity_id, expect_ok, label="validate entity", expected_entity_type=None):
...
def _validate_instance(instance_id, expect_ok, label="validate instance", expected_id=None):
